...
import pytest
from source_wolt.source import WoltStream


@pytest.fixture
def patch_base_class(mocker):
    # Mock abstract methods to enable instantiating abstract class
    mocker.patch.object(WoltStream, "path", "v0/example_endpoint")
    mocker.patch.object(WoltStream, "primary_key", "test_primary_key")
    mocker.patch.object(WoltStream, "__abstractmethods__", set())
